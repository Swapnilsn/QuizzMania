      ...
      // startTimer();
        ...
        option1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (selectOptionByUser.isEmpty())
                {
                    ...
                    revrealAnswer();
                    questionsLists.get(currentQuestionposition).setUserSelectedAnswer(selectOptionByUser);
                }
                else {
                    changeNextQuestion();
                }
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(selectOptionByUser.isEmpty())
                {
                    Toast.makeText(QuizActivity1.this, " Please Select an Option", Toast.LENGTH_SHORT).show();
                }
                else {
                    changeNextQuestion();
                }
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(QuizActivity1.this,QuizActivity.class));
                finish();
            }
        });
            ...
            public void run() {
                if(seconds==0){
                  ...
                  totalTimeInMins --;
                    ...
                    quizTimer.purge();
                    quizTimer.cancel();
                    Toast.makeText(QuizActivity1.this, "Time Over", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(QuizActivity1.this, QuizResults.class);
